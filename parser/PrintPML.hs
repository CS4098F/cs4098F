...
instance Print PML_PROCESS where
  prt i e = case e of
...
instance Print EXPR where
  prt i e = case e of
    DisjExpr expr2 expr3 -> prPrec i 2 (concatD [prt 2 expr2, doc (showString "||"), prt 3 expr3])
    ConjExpr expr3 expr4 -> prPrec i 3 (concatD [prt 3 expr3, doc (showString "&&"), prt 4 expr4])
    ...
    PrimNot expr5 -> prPrec i 5 (concatD [doc (showString "!"), prt 5 expr5])
