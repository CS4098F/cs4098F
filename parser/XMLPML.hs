...
instance XPrint PML_PROCESS where
  prt i e = case e of
   Process id prims -> concat $  elemFun i "PML_PROCESS" "Process" : prt (i+1) id : prt (i+1) prims : [[replicate (i+i) ' ' ++ endtag "Process" "PML_PROCESS"]]
